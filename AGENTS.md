...
Follow all rules in `agent.md` for every change in this repository. In case of ambiguity, protect user work, avoid destructive Git operations, and keep the playable `main` branch deployable.

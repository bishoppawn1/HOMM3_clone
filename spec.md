...
Artillery is a separate slow, long-range line with a base range of 12 hexes, increasing to 15 for modern rocket artillery. The armored line reduces incoming damage by 25 percent and gains ranged weapons beginning with Armored Gun Wagons in the Gunpowder Age. The aerial line is fast but does not gain true flight until Balloon Observers in the Gunpowder Age; flying stacks may cross and occupy otherwise impassable battlefield obstacle hexes, though living stacks still block them. These are grounded machines and military formations rather than fantasy creatures.
